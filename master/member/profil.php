<?php
	...
	switch($act){
		default:
			...
			<h1>PROFILKU</h1>
			<hr size="5" color="#eee">
			<form method="POST" action="?module=profil&act=edit&id=<?php echo $id;?>">
				...
				<table>
					...
					<tr>
						<td colspan="2"><input type="submit" class="tombolReset" value="Edit"></td>
					</tr>
				</table>
				</form>
		...
		case "edit":
			...
			<form method="POST" action="?module=profil&act=edit_simpan">
				<table>
					<tr bgcolor='F0F0F0'>
						<td>Nama Lengkap</td>
					...
					<tr bgcolor='F0F0F0'>
						<td>Tanggal Lahir</td>
						<td><input type="date" name="txt_tgl_lahir" value="<?php echo $data_user["TGL_LAHIR"];?>"></td>
					</tr>
					<tr bgcolor='white'>
						<td>Jenis Kelamin</td>
